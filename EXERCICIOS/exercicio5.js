...
console.log(nome2("CHOCOTONE E OVO DE PÁSCOA JUNTOS NO MERCADO EM PLENO FEVEREIRO"))
/*
04
- Crie uma função que recebe 2 parâmetros: um caractere e uma string;
- Ao ser invocada, a função deve retornar o index do caractere na string.
*/
const nome3 = (string, caracter)=>{
    return string.indexOf(caracter)
}
console.log(nome3('nome', 'e'))
/*
05
- Crie uma função que, ao ser invocada, retorna um boolean indicando se o item  
  passado por argumento existe no array (também passado por argumento).
*/
function existeNoArray(item, array){
    return array.includes(item)
}
console.log(existeNoArray('abacaxi', ['abacaxi']))
...
console.log(concatenaArray([5,2,3],[20,5,7]))
/*
07
...
console.log(removeItemArray([5,7,9]))
/*
08
- Crie uma função que retorna se o valor passado como argumento em sua  
  invocação é null.
*/
function valorNull(item){
    if(typeof item == 'null'){
        return 'é null'
    }else{
        return 'não é null'
...
console.log(callback2(triplo(33)))
/*
11
...
const arr6 = ['Deivide', 'Felipe', 'Soares', 'Bezerra']
function curtirPost(array){
